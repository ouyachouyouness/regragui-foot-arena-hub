        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Regragui Football Academy</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/reservation" className="text-gray-400 hover:text-green-400 transition-colors">Réservation</Link></li>
              <li><Link to="/abonnements" className="text-gray-400 hover:text-green-400 transition-colors">Abonnements</Link></li>
              <li><Link to="/galerie" className="text-gray-400 hover:text-green-400 transition-colors">Galerie</Link></li>
